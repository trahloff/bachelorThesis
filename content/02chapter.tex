...
\begin{enumerate}
    ...
    \item \textbf{Hammond, Rymer} \\
        ...
        These services share four core elements. They: Support deployment of arbitrary business logic [...], Decouple state and compute [...], Automatically invoke and scale deployed logic [...], Support event sources and sinks [...]"~\cfcite{Hammond2018DemystifyingComputing}
    \item \textbf{Johnston}\\
        ...
        A Serverless system such as this would be very low on maintenance too and is inherently event driven. If it wasn’t event-driven, then you’d need to pay to ensure that a system is always available and idle (like an EC2 instance)"~\cfcite{Johnston2017AServerless}
    \item \textbf{Kehoe}\\
        ...
        \end{enumerate}
        [...] Serverless is, at a functional level, about lower operations burden and faster time to market."~\cfcite{Kehoe2017TheSpectrum}
    \item \textbf{Castro et. al.}\\\label{castro}
        ...
        and
        charges for actual usage at a millisecond granularity"~\cfcite{Castro2017ServerlessService}
    ...
    \item \textbf{serverless.com}\\
        ...
        Ultimately, serverless is about focusing your efforts on what provides value to your users. This means using managed services for databases, search indexes, queues, SMS messaging, and email delivery. It means tying these services together using stateless, ephemeral compute like the various FaaS offerings."~\cfcite{ServerlessTeam2017WhyServerless}
\end{enumerate}
